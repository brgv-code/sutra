			...
			<div className='max-w-4xl h-screen mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8  b-shadow'>
				<div className='flex flex-col items-center lg:flex-row lg:space-x-8'>
					...
					<div>
						...
						<p className='mt-4 text-lg '>
							fullstack dev at Foundamental gmbh, Berlin, Germany where I work
							on a B2B SAAS product, Loura. Before I was a fullstack dev at
							...
							well and when I am not doing any of the above, I am either reading
				...
				<div className='mt-8'>
					...
					<ul className='mt-2 text-lg  list-disc list-inside'>
						...
						<li>
							Software Engineer at Accenture,India June 2017 - October 2021
						</li>
					</ul>
				</div>
				<div className='mt-8'>
					...
					<p className='mt-2 text-lg '>
						Proficient in Typescript, NextJS, GraphQL, Edgedb and more.
					</p>
				</div>
				<div className='mt-8'>
					<h2 className='text-2xl font-bold '>Education</h2>
					<ul className='mt-2 text-lg  list-disc list-inside'>
						<li>Msc in RCSE from TU Ilmenau,Germany</li>
						<li>B.E. from NIE,Mysuru,India</li>
					</ul>
				</div>
				<div className='mt-8'>
